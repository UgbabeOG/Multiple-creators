...
export default function VideoGalleryItem({ video, 'data-ai-hint': dataAiHint }: VideoGalleryItemProps) {
  return (
    <Link href={`/videos/${video.id}`} className="group block">
      <Card className="overflow-hidden h-full flex flex-col hover:shadow-xl hover:border-accent transition-all duration-300 ease-in-out transform hover:-translate-y-1">
