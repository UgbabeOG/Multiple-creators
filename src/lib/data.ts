...
export const videos: Video[] = [
  {
    ...
    initialDescription:
      "Experience 'Fine Wine', a stunning voyage into the heart of the universe. Directed with a keen eye for breathtaking visuals and emotive storytelling.",
  },
  {
    id: "its-ok",
    title: "Its Okay",
  ...
  },
  {
    ...
    initialDescription:
      "'Yourside' captures the ephemeral beauty of nature in a mesmerizing dance of growth and color. A tranquil and poetic visual experience.",
  },
  {
    id: "2mins",
    title: "2Mins",
    ...
    videoUrl: "https://www.youtube.com/embed/S0I1Bnt6EDM?si=Z3WDEzkhQUODdfdD",
    ...
    initialDescription:
      "Feel the pulse of the city in '2Mins'. A vibrant and authentic portrayal of metropolitan life, full of energy and character.",
  },
];
